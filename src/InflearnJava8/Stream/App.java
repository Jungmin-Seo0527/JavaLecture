...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("4. 두 수업 목록에 들어었는 모든 수업 아이디 출력");
        keesunEvents.stream()
        ...
        System.out.println("6. 자바 수업 중에 TEST 가 들어있는 수업이 있는지 확인");
        boolean test = javaClasses.stream().anyMatch(oc -> oc.getTitle().contains("Test"));
        System.out.println(test);

        System.out.println("7. 스프링 수업 중에 제목에 spring 이 들어간 제목만 모아서 List로 만들기");
